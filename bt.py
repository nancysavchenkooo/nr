...
-----------------------------------------------------""")
    ...
    def ua_asu(self):
        ...
        return (f"Dalvik/2.1.0 (Linux; U; Android {vers}; RMX3396 Build/{xnxx}) [FBAN/EMA;FBBV/470353487;FBAV/353.0.0.5.112;FBDV/RMX3396;FBLC/id_ID;FBNG/WIFI;FBMNT/METERED;FBDM/"+"{density=3.0}]")
